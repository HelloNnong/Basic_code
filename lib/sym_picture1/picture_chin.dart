...
class Picture_chin extends StatefulWidget {
  const Picture_chin({Key? key}) : super(key: key);

  @override
  State<Picture_chin> createState() => _Picture_chinState();
}
...
class _Picture_chinState extends State<Picture_chin> {
  ...
  List<Widget> _buildGridCards(BuildContext context) {
    ...
    List<Product> filteredProducts = products.where((product) => product.id.startsWith('8-')).toList();
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    AspectRatio(
                      ...
                      child: Image.asset(
                        //fit: BoxFit.fitWidth,
                        'assets/images/sym/chin/${product.id}.png', // 이미지 가져오기
                      ),
                    ),
                  ],
                ),
